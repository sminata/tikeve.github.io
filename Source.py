...
class Source:
    def __init__(self, source):
        ...
        self.TeamThreat = TeamThreat
        self.TeamCreativity = TeamCreativity
        self.TeamThreatAd = TeamThreatAd
        self.TeamCreativityAd = TeamCreativityAd
        self.TableTeams = TableTeams
        self.PlayerThreat = PlayerThreat
        self.PlayerCreativity = PlayerCreativity
        self.PlayerThreatAd = PlayerThreatAd
        self.PlayerCreativityAd = PlayerCreativityAd
        

Understat = Source('Understat')
Understat.PlayerCreativityAd


# In[34]:


Understat.TableTeams
